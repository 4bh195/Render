...
url1 = "https://firebasestorage.googleapis.com/v0/b/crud-firebase-c961c.appspot.com/o/82897E84-96E5-4F0C-B96A-5D135C05A563.jpg?alt=media&token=d7460e7e-ede5-471d-99b8-140ab032cbfc","wb")
...
#URL where the image is stored
url2 = "https://firebasestorage.googleapis.com/v0/b/crud-firebase-c961c.appspot.com/o/Screen%20Shot%202017-12-09%20at%201.00.10%20AM.png?alt=media&token=1d24ee65-2f11-45de-b225-1c3e38fc5dcf","wb")
...
if __name__ == '__main__':
    ...
    backGr = cv2.imread(path1)
    fgr = cv2.imread(path2)
